...
function () {
  ...
  _createClass(WebMentions, [{
    ...
    value: function fetchMentions() {
      ...
      var webmentions, list;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function fetchMentions$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.getWebmentions(this.container.dataset.webmentions));

            case 3:
              webmentions = _context.sent;
            ...
            case 6:
              ...
              webmentions.forEach(function (webmention) {
                list.appendChild(_this.renderWebmention(webmention));
              });
    ...
    key: "getWebmentions",
    value: function getWebmentions(target) {
      return fetch("https://webmention.io/api/mentions.jf2?target=".concat(target)).then(function (response) {
    ...
    key: "renderWebmention",
    value: function renderWebmention(webmention) {
      var action = {
        "in-reply-to": "replied",
        "like-of": "liked",
        "repost-of": "reposted",
      ...
      var rendered = document.importNode(document.getElementById("webmention-template").content, true);
      ...
      set(".webmention-author-avatar", "alt", "Photo of ".concat(webmention.author.name));
      set(".webmention-author-name", "textContent", webmention.author.name);
      set(".webmention-action", "href", webmention.url);
      set(".webmention-action", "textContent", "".concat(action, " on ").concat(webmention["wm-received"].substr(0, 10)));

      if (webmention.content) {
        set(".webmention-content", "innerHTML", webmention.content.html || webmention.content.text);
      } else {
